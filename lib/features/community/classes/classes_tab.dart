...
class ClassesTab extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return currentUser.role == UserRole.teacher
        ? _TeacherClassesView(currentUser: currentUser)
        : _StudentClassesView(currentUser: currentUser);
  }
}
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                ...
                children: teachers.take(3).map((t) => Padding(
            ...
            if (classes.isEmpty) {
              return const Padding(
                ...
                child: Text('No classes available yet.',
                    style: TextStyle(
                        fontFamily: 'Cairo', color: AppColors.textGrey)),
              );
            }
            return SizedBox(
              height: 320,
          ...
          child: Column(
            ...
            children: [
              ...
              if (all.isEmpty)
                ...
                ...all.take(10).map((c) => _CourseRow(
                  cls: c,
                  isEnrolled: _isEnrolled(c),
                )),
            ],
          ),
        );
...
class _TeacherClassesView extends StatelessWidget {
              ...
              child: const Row(
                ...
                children: [
                  Icon(Icons.add_circle_outline_rounded,
                      color: AppColors.primaryDarkest, size: 18),
                  SizedBox(width: 8),
      ...
      builder: (ctx, snap) {
        ...
        if (snap.hasError) {
          return Padding(
            ...
            child: Text('Error loading classes: ${snap.error}',
                style: const TextStyle(
          ...
          child: Column(
            ...
            children: [
              ...
              if (classes.isEmpty)
                Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      const Text('Tap "Create New Class" above to get started.',
                ...
                ...classes.map((c) => _TeacherClassCard(
                  cls: c,
                  onScheduleMeeting: () =>
        ...
        return Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 10),
              ...others.take(5).map((c) => _CourseRow(
                cls: c,
        ...
        builder: (ctx2, setBS) => Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 4),
              const Text('Submitted classes are reviewed by admin before going live.',
                  style: TextStyle(
                      fontFamily: 'Cairo', fontSize: 12,
                      color: AppColors.textGrey)),
              const SizedBox(height: 16),
              ...
              Row(
                children: [
                  Expanded(
                    child: _sheetField('Duration (minutes)', durationCtrl,
                  ...
                  Expanded(
                    child: DropdownButtonFormField<String>(
                      ...
                      items: ['Quran', 'Fiqh', 'Seerah', 'Tajweed', 'Arabic', 'Hadith', 'Aqeedah']
        ...
        builder: (ctx2, setBS) => Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(cls.title,
                  style: const TextStyle(
                    fontFamily: 'Cairo', fontSize: 13, color: AppColors.gold,
                    fontWeight: FontWeight.w600,
                  )),
              const SizedBox(height: 16),
              ...
              Row(
                children: [
                  ...
                  const Spacer(),
                  ...[30, 60, 90, 120].map((d) => GestureDetector(
              ...
              GestureDetector(
                ...
                child: Container(
                  ...
                  child: const Center(
                    child: Text('Schedule & Notify Students',
                        style: TextStyle(
                          fontFamily: 'Cairo', fontSize: 14,
                          fontWeight: FontWeight.w700,
                          color: AppColors.primaryDarkest,
  ...
  Widget _sheetField(String hint, TextEditingController ctrl,
      {int maxLines = 1, TextInputType keyboard = TextInputType.text, Function(String)? onChanged}) {
    return Container(
      decoration: BoxDecoration(
        color: AppColors.bgWhite,
        borderRadius: BorderRadius.circular(12),
...
class _ClassCard extends StatelessWidget {
  ...
  Color get _headerColor =>
      _catColors[cls.category] ?? AppColors.primaryDark;

  @override
  Widget build(BuildContext context) {
    final enrolledCount =
        cls.studentIds.where((id) => id.isNotEmpty).length;
    return Container(
...
class _CourseRow extends StatelessWidget {
  final ClassModel cls;
  final bool isEnrolled;
  const _CourseRow({required this.cls, required this.isEnrolled});
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text('${cls.teacherName} · $enrolledCount students',
                    style: const TextStyle(
                        fontFamily: 'Cairo',
                        fontSize: 11,
                        color: AppColors.textGrey)),
...
class _TeacherClassCard extends StatelessWidget {
  ...
  const _TeacherClassCard(
      {required this.cls, required this.onScheduleMeeting});
