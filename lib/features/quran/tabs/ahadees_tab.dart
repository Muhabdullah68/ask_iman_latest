...
class AhadeesTab extends StatefulWidget {
  ...
  @override
  State<AhadeesTab> createState() => _AhadeesTabState();
}
        ...
        child: Column(
          ...
          children: [
            Text(
              ...
              style: TextStyle(
                fontFamily: widget.arabicFont ?? 'Amiri',
                fontSize: 16,
          ...
          child: Stack(
            ...
            children: [
              Image.asset(
                ...
                fit: BoxFit.cover,
                errorBuilder: (_, _, _) =>
                    Container(color: AppColors.primaryDarkest),
              ),
              Container(
      ...
      child: Column(
        ...
        children: [
          ...
          if (eng.isNotEmpty) ...[
            ...
            if (useUrduFont)
              const Text(
                '(Urdu translation for Hadiths coming soon)',
                style: TextStyle(
                  fontFamily: 'Cairo',
                  fontSize: 11,
                  color: AppColors.textGreenMuted,
...
class _TopicFilterScreen extends StatefulWidget {
  ...
  @override
  State<_TopicFilterScreen> createState() => _TopicFilterScreenState();
}
...
class _TopicFilterScreenState extends State<_TopicFilterScreen> {
  ...
  List<Map<String, String>> get _filtered =>
      _filterHadiths(AhadeesData.byTopic(_topic));
            ...
            Expanded(
              child: _filtered.isEmpty
                  ? Center(
                      child: Text(
                        widget.searchQuery.isEmpty
                            ...
                            : 'No hadiths found for your search.',
                        style: const TextStyle(
                          fontFamily: 'Cairo',
                          color: AppColors.textGrey,
                        ),
                  ...
                  : ListView(
                      ...
                      children: _filtered
                          .map((h) => _LocalHadithCard(hadith: h))
                          .toList(),
                    ),
            ),
          ],
