...
class _LocalData {
  ...
  static const Map<int, List<Map<String, String>>> ayahs = {
    1: [
      {
        'a': 'بِسۡمِ ٱللَّهِ ٱلرَّحۡمَٰنِ ٱلرَّحِيمِ',
        't':
            'In the name of Allah, the Entirely Merciful, the Especially Merciful.',
        'tu': 'اللہ کے نام سے جو بہت بڑا مہربان نہایت رحم والا ہے',
        'num': '1',
      },
      {
        'a': 'ٱلۡحَمۡدُ لِلَّهِ رَبِّ ٱلۡعَٰلَمِينَ',
        't': '[All] praise is [due] to Allah, Lord of the worlds –',
        'tu': 'سب تعریفیں اللہ ہی کے لیے ہیں جو تمام جہانوں کا پالنے والا ہے',
        'num': '2',
      },
      {
        'a': 'ٱلرَّحۡمَٰنِ ٱلرَّحِيمِ',
        't': 'The Entirely Merciful, the Especially Merciful,',
        'tu': 'بہت بڑا مہربان نہایت رحم والا ہے',
        'num': '3',
      },
      {
        'a': 'مَٰلِكِ يَوۡمِ ٱلدِّينِ',
        't': 'Sovereign of the Day of Recompense.',
        'tu': 'روزِ جزا کا مالک ہے',
        'num': '4',
      },
      {
        'a': 'إِيَّاكَ نَعۡبُدُ وَإِيَّاكَ نَسۡتَعِينُ',
        't': 'It is You we worship and You we ask for help.',
        'tu': 'ہم تیری ہی عبادت کرتے ہیں اور تجھ ہی سے مدد چاہتے ہیں',
        'num': '5',
      },
      {
        'a': 'ٱهۡدِنَا ٱلصِّرَٰطَ ٱلۡمُسۡتَقِيمَ',
        't': 'Guide us to the straight path –',
        'tu': 'ہمیں سیدھی راہ دکھا',
        'num': '6',
      },
      {
        'a':
        ...
        'tu':
            'ان لوگوں کی راہ جن پر تو نے انعام کیا نہ کہ ان کی جن پر غضب کیا گیا اور نہ گمراہوں کی',
        'num': '7',
      },
    ],
    36: [
      ...
      {
        'a': 'إِنَّكَ لَمِنَ ٱلۡمُرۡسَلِينَ',
        't': 'Indeed you, [O Muhammad], are from among the messengers,',
        'num': '3',
      },
      {
        'a': 'عَلَىٰ صِرَٰطٍ مُّسۡتَقِيمٍ',
        't': 'On a straight path.',
        'num': '4',
      },
      {
        'a': 'تَنزِيلَ ٱلۡعَزِيزِ ٱلرَّحِيمِ',
        't': '[This is] a revelation of the Exalted in Might, the Merciful,',
        'num': '5',
      },
    ],
    67: [
      {
        'a':
            'تَبَٰرَكَ ٱلَّذِي بِيَدِهِ ٱلۡمُلۡكُ وَهُوَ عَلَىٰ كُلِّ شَيۡءٍ قَدِيرٌ',
        't':
      ...
      {
        'a': 'ٱلَّذِي خَلَقَ سَبۡعَ سَمَٰوَٰتٍ طِبَاقًا',
        't': '[And] who created seven heavens in layers.',
        'num': '3',
      },
    ],
    112: [
      {
        'a': 'قُلۡ هُوَ ٱللَّهُ أَحَدٌ',
        't': 'Say, "He is Allah, [who is] One,',
        'num': '1',
      },
      {'a': 'ٱللَّهُ ٱلصَّمَدُ', 't': 'Allah, the Eternal Refuge.', 'num': '2'},
      {
        'a': 'لَمۡ يَلِدۡ وَلَمۡ يُولَدۡ',
        't': 'He neither begets nor is born,',
        'num': '3',
      },
      {
        'a': 'وَلَمۡ يَكُن لَّهُۥ كُفُوًا أَحَدٌ',
        't': 'Nor is there to Him any equivalent."',
        'num': '4',
      },
    ],
    113: [
      {
        'a': 'قُلۡ أَعُوذُ بِرَبِّ ٱلۡفَلَقِ',
        't': 'Say, "I seek refuge in the Lord of daybreak',
        'num': '1',
      },
      {
        'a': 'مِن شَرِّ مَا خَلَقَ',
        't': 'From the evil of that which He created',
        'num': '2',
      },
      {
        'a': 'وَمِن شَرِّ غَاسِقٍ إِذَا وَقَبَ',
        't': 'And from the evil of darkness when it settles',
        'num': '3',
      },
      {
        'a': 'وَمِن شَرِّ ٱلنَّفَّٰثَٰتِ فِي ٱلۡعُقَدِ',
        't': 'And from the evil of the blowers in knots',
        'num': '4',
      },
      {
        'a': 'وَمِن شَرِّ حَاسِدٍ إِذَا حَسَدَ',
        't': 'And from the evil of an envier when he envies."',
        'num': '5',
      },
    ],
    114: [
      {
        'a': 'قُلۡ أَعُوذُ بِرَبِّ ٱلنَّاسِ',
        't': 'Say, "I seek refuge in the Lord of mankind,',
        'num': '1',
      },
      {'a': 'مَلِكِ ٱلنَّاسِ', 't': 'The Sovereign of mankind.', 'num': '2'},
      {'a': 'إِلَٰهِ ٱلنَّاسِ', 't': 'The God of mankind,', 'num': '3'},
      {
        'a': 'مِن شَرِّ ٱلۡوَسۡوَاسِ ٱلۡخَنَّاسِ',
        't': 'From the evil of the retreating whisperer –',
        'num': '4',
      },
      {
        'a': 'ٱلَّذِي يُوَسۡوِسُ فِي صُدُورِ ٱلنَّاسِ',
        't': 'Who whispers [evil] into the breasts of mankind –',
        'num': '5',
      },
      {
        'a': 'مِنَ ٱلۡجِنَّةِ وَٱلنَّاسِ',
        't': 'From among the jinn and mankind."',
        'num': '6',
      },
    ],
  };
  ...
  static const Map<int, Map<String, String>> tafseer = {
    1: {
      'Ibn Kathir':
          'Al-Fatihah is the greatest surah in the Quran. The Prophet said it is "the Mother of the Book, the seven oft-repeated verses, and the Great Quran." It encompasses praise of Allah, affirmation of His lordship, His mercy and sovereignty over the Day of Judgment, the declaration of exclusive worship, and the supplication for guidance.',
      "Ma'ariful Quran":
          "Mufti Muhammad Shafi explains: Allah Himself taught this surah as the perfect way for humanity to address Him. The seven verses cover three realities: divine attributes (Rahman, Rahim, Malik), the covenant of exclusive worship, and the request for guidance.",
      'Al-Jalalayn':
          'Bismillah: In the name of Allah, the name encompassing all divine attributes. Al-hamdulillah: all praise belongs to Allah exclusively, as He alone is the source of all blessing.',
    },
    36: {
      'Ibn Kathir':
          'The Prophet described Ya-Sin as "the heart of the Quran." The surah confirms prophethood through an oath on the Quran, then narrates the parable of the city whose people rejected messengers.',
      "Ma'ariful Quran":
          "The Quran uses Ya-Sin to introduce its affirmation of the Prophets mission. Three major themes: prophethood, resurrection, and divine power manifest in creation.",
      'Al-Jalalayn':
          "The oath Wal Quranil Hakeem has its response in Innaka la minal mursaleen confirming the Prophets status.",
    },
    67: {
      'Ibn Kathir':
          "Al-Mulk protects its reciter from punishment in the grave. Tabaraka indicates that Allahs blessings are perfect and overflowing. He created death before life as a test.",
      "Ma'ariful Quran":
          'The surah opens with an affirmation that all sovereignty belongs exclusively to Allah. The purpose of death and life is to test who is best in deeds.',
      'Al-Jalalayn':
          'Tabaraka: Exalted is He, whose blessings are perfect. Bi yadihi al-mulk: In His hand is dominion. The creation of death before life signifies that this world is temporary by design.',
    },
    112: {
      'Ibn Kathir':
          "Surah Al-Ikhlas is equivalent to one third of the Quran. Ahad means He is absolutely One. As-Samad means the Master whom all creation depends upon.",
      "Ma'ariful Quran":
          'This surah refutes three forms of shirk: partners with Allah, claiming He has offspring, and comparing Him to creation.',
      'Al-Jalalayn':
          'Say (qul) — a command to declare. Huwa: He — pointing to the divine essence. Ahad: the Unique One with no equal.',
    },
  };
}
...
class QuranApiService {
  ...
  static Future<String?> fetchTafseer(
    int surahNum,
    int ayahNum,
    String source, {
    bool isUrdu = false,
    ...
    final id = isUrdu
        ? (source == 'Ibn Kathir'
              ? 159
              : (source == "Ma'ariful Quran" ? 161 : 158))
        : (ids[source] ?? 169);
    ...
    try {
      final r = await http
          .get(
            Uri.parse(
              'https://api.quran.com/api/v4/tafsirs/$id/by_ayah?verse_key=$surahNum:$ayahNum',
            ),
  ...
  static Future<List<Map<String, dynamic>>?> fetchChapterTafseer(
    int surahNum,
    String source, {
    bool isUrdu = false,
  }) async {
    ...
    try {
      final r = await http
          .get(
            Uri.parse(
              'https://api.quran.com/api/v4/tafsirs/$id/by_chapter/$surahNum',
            ),
            headers: {'Accept': 'application/json'},
          )
